...
var G__929 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__929;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__930 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__930,ch);
...
if(("\\" === ch__$1)){
var ch_931__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_931__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_931__$2);
} else {
}

var G__932 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__932;
continue;
}
}
...
var vec__940 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__940,(0),null);
var start_column = cljs.core.nth.call(null,vec__940,(1),null);
...
var G__943 = cljs.core.conj_BANG_.call(null,a,form);
a = G__943;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__944 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__945 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__945);

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__944);
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__946 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__946,(0),null);
var start_column = cljs.core.nth.call(null,vec__946,(1),null);
...
var vec__949 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__949,(0),null);
var end_column = cljs.core.nth.call(null,vec__949,(1),null);
...
var vec__952 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__952,(0),null);
var start_column = cljs.core.nth.call(null,vec__952,(1),null);
...
var vec__955 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__955,(0),null);
var end_column = cljs.core.nth.call(null,vec__955,(1),null);
...
var vec__958 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__958,(0),null);
var start_column = cljs.core.nth.call(null,vec__958,(1),null);
...
var vec__961 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__961,(0),null);
var end_column = cljs.core.nth.call(null,vec__961,(1),null);
...
var sb = (function (){var G__964 = (new goog.string.StringBuffer());
G__964.append(initch);
...
var G__966 = (function (){var G__965 = sb;
G__965.append(ch);

return G__965;
})();
var G__967 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__966;
ch = G__967;
continue;
}
...
switch (G__970) {
case "\\":
var G__974 = (function (){var G__971 = sb;
G__971.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__971;
})();
var G__975 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__974;
ch = G__975;
continue;
...
break;
default:
var G__976 = (function (){var G__972 = sb;
G__972.append(ch);

return G__972;
})();
var G__977 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__976;
ch = G__977;
continue;
...
var vec__978 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__978,(0),null);
var end_column = cljs.core.nth.call(null,vec__978,(1),null);
...
var vec__981 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__981,(0),null);
var column = cljs.core.nth.call(null,vec__981,(1),null);
...
var vec__986 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__986,(0),null);
var column = cljs.core.nth.call(null,vec__986,(1),null);
...
var vec__991 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__991,(0),null);
var column = cljs.core.nth.call(null,vec__991,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__996 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__996,(0),null);
var start_column = cljs.core.nth.call(null,vec__996,(1),null);
...
var vec__999 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__999,(0),null);
var end_column = cljs.core.nth.call(null,vec__999,(1),null);
...
var G__1002 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__1002,true,null,opts,pending_forms);
...
var G__1003 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__1003)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__1003)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__1003)){
...
var _STAR_suppress_read_STAR__orig_val__1004 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__1005 = true;
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__1005);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__1004);
}});
...
var G__1006 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__1006,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__1006,rdr,first_line);
...
var G__1010 = matched;
var G__1011 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__1010;
finished = G__1011;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__1012 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__1013 = (function (){var or__5043__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
...
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__1013);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__1012);
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__1014 = cljs.tools.reader.arg_env;
var arg_env_temp_val__1015 = cljs.core.sorted_map.call(null);
(cljs.tools.reader.arg_env = arg_env_temp_val__1015);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__1016 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__1016,"(");
...
var G__1017 = (i + (1));
var G__1018 = cljs.core.conj_BANG_.call(null,args,(function (){var or__5043__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__1014);
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__1019 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__1019);
...
var G__1020 = cljs.core.next.call(null,s__$1);
var G__1021 = ret;
s__$1 = G__1020;
r = G__1021;
continue;
...
var G__1022 = cljs.core.next.call(null,s);
var G__1023 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__1022;
key_vals = G__1023;
continue;
} else {
...
var gensym_env_orig_val__1026 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__1027 = cljs.core.PersistentArrayMap.EMPTY;
(cljs.tools.reader.gensym_env = gensym_env_temp_val__1027);
...
}finally {(cljs.tools.reader.gensym_env = gensym_env_orig_val__1026);
}});
cljs.tools.reader.read_namespaced_map = (function cljs$tools$reader$read_namespaced_map(rdr,_,opts,pending_forms){
var vec__1028 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__1028,(0),null);
var start_column = cljs.core.nth.call(null,vec__1028,(1),null);
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__1031 = token;
var G__1031__$1 = (((G__1031 == null))?null:cljs.core.subs.call(null,G__1031,(1)));
var G__1031__$2 = (((G__1031__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__1031__$1));
var G__1031__$3 = (((G__1031__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__1031__$2));
var G__1031__$4 = (((G__1031__$3 == null))?null:cljs.core.symbol.call(null,G__1031__$3));
if((G__1031__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__1031__$4);
}
})():(function (){var G__1032 = token;
var G__1032__$1 = (((G__1032 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__1032));
if((G__1032__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__1032__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
var vec__1033 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__1033,(0),null);
var end_column = cljs.core.nth.call(null,vec__1033,(1),null);
...
return cljs.core.with_meta.call(null,cljs.core.zipmap.call(null,keys,vals),(cljs.core.truth_(start_line)?cljs.core.merge.call(null,(function (){var temp__5457__auto__ = cljs.tools.reader.reader_types.get_file_name.call(null,rdr);
if(cljs.core.truth_(temp__5457__auto__)){
var file = temp__5457__auto__;
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"file","file",-1269645878),file], null);
} else {
...
var temp__5455__auto__ = (function (){var or__5043__auto__ = cljs.tools.reader._STAR_data_readers_STAR_.call(null,tag);
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
...
}catch (e1042){if((e1042 instanceof Error)){
var e = e1042;
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__1046,reader){
var map__1047 = p__1046;
var map__1047__$1 = cljs.core.__destructure_map.call(null,map__1047);
var opts = map__1047__$1;
var eof = cljs.core.get.call(null,map__1047__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
