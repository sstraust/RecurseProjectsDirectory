...
return cljs.core._write.call(null,writer__5328__auto__,"reagent.impl.template/NativeWrapper");
}));
...
var G__5540 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__5540,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__5542__i = 0, G__5542__a = new Array(arguments.length -  0);
while (G__5542__i < G__5542__a.length) {G__5542__a[G__5542__i] = arguments[G__5542__i + 0]; ++G__5542__i;}
  args = new cljs.core.IndexedSeq(G__5542__a,0,null);
} 
return G__5541__delegate.call(this,args);};
G__5541.cljs$lang$maxFixedArity = 0;
G__5541.cljs$lang$applyTo = (function (arglist__5543){
...
var G__5544 = o;
reagent.impl.template.goog$module$goog$object.set.call(null,G__5544,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var args = null;
if (arguments.length > 0) {
var G__5546__i = 0, G__5546__a = new Array(arguments.length -  0);
while (G__5546__i < G__5546__a.length) {G__5546__a[G__5546__i] = arguments[G__5546__i + 0]; ++G__5546__i;}
  args = new cljs.core.IndexedSeq(G__5546__a,0,null);
} 
return G__5545__delegate.call(this,args);};
G__5545.cljs$lang$maxFixedArity = 0;
G__5545.cljs$lang$applyTo = (function (arglist__5547){
...
var G__5548 = props;
var G__5548__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__5548,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__5548);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__5548__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__5043__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__5549 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__5549,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__5549;
}
})(),id_class);
...
var G__5550 = (cljs.core.count.call(null,argv) - first_child);
switch (G__5550) {
case (0):
...
return cljs.core._write.call(null,writer__5328__auto__,"reagent.impl.template/HiccupTag");
}));
...
var vec__5552 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__5552,(0),null);
var id = cljs.core.nth.call(null,vec__5552,(1),null);
var className = cljs.core.nth.call(null,vec__5552,(2),null);
...
var temp__5461__auto___5555 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5461__auto___5555 == null)){
} else {
var key_5556 = temp__5461__auto___5555;
(jsprops.key = key_5556);
}
...
var temp__5461__auto___5557 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5461__auto___5557 == null)){
} else {
var key_5558 = temp__5461__auto___5557;
(jsprops.key = key_5558);
}
...
var jsprops = (function (){var or__5043__auto__ = reagent.impl.template.convert_prop_value.call(null,((hasprops)?props:null));
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return ({});
...
var temp__5461__auto___5559 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5461__auto___5559 == null)){
} else {
var key_5560 = temp__5461__auto___5559;
(jsprops.key = key_5560);
}
...
var hasprops = (((props == null)) || (cljs.core.map_QMARK_.call(null,props)));
var jsprops = (function (){var or__5043__auto__ = reagent.impl.template.convert_props.call(null,((hasprops)?props:null),parsed);
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return ({});
...
var temp__5461__auto___5561 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5461__auto___5561 == null)){
} else {
var key_5562 = temp__5461__auto___5561;
(jsprops.key = key_5562);
}
...
var temp__5461__auto___5563 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5461__auto___5563 == null)){
} else {
var key_5564 = temp__5461__auto___5563;
(jsprops.key = key_5564);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__5565_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__5565_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__5566 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__5566,(0),null);
var derefed = cljs.core.nth.call(null,vec__5566,(1),null);
...
break;
default:
var G__5571 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__5572 = compiler;
v = G__5571;
compiler = G__5572;
continue;
...
var G__5573 = tag;
var G__5573__$1 = (((G__5573 instanceof cljs.core.Keyword))?G__5573.fqn:null);
switch (G__5573__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template5576 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template5576 = (function (opts,id,fn_to_element,parse_fn,meta5577){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template5576.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_5578,meta5577__$1){
var self__ = this;
var _5578__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template5576(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta5577__$1));
}));

(reagent.impl.template.t_reagent$impl$template5576.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_5578){
var self__ = this;
var _5578__$1 = this;
return self__.meta5577;
}));

(reagent.impl.template.t_reagent$impl$template5576.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template5576.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template5576.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
return self__.parse_fn.call(null,this$__$1,tag_name,tag_value);
}));

(reagent.impl.template.t_reagent$impl$template5576.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template5576.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template5576.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta5577","meta5577",-1365685486,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template5576.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template5576.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template5576");

(reagent.impl.template.t_reagent$impl$template5576.cljs$lang$ctorPrWriter = (function (this__5327__auto__,writer__5328__auto__,opt__5329__auto__){
return cljs.core._write.call(null,writer__5328__auto__,"reagent.impl.template/t_reagent$impl$template5576");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template5576.
 */
reagent.impl.template.__GT_t_reagent$impl$template5576 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template5576(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta5577){
return (new reagent.impl.template.t_reagent$impl$template5576(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta5577));
});

}

return (new reagent.impl.template.t_reagent$impl$template5576(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
