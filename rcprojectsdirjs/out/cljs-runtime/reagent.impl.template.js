...
var G__45484 = o;
reagent.impl.template.goog$module$goog$object.set(G__45484,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
return (function() { 
var G__45521__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__45521 = function (var_args){
var args = null;
...
return G__45521__delegate.call(this,args);};
G__45521.cljs$lang$maxFixedArity = 0;
G__45521.cljs$lang$applyTo = (function (arglist__45523){
var args = cljs.core.seq(arglist__45523);
return G__45521__delegate(args);
});
G__45521.cljs$core$IFn$_invoke$arity$variadic = G__45521__delegate;
return G__45521;
})()
;
} else {
...
var G__45485 = o;
reagent.impl.template.goog$module$goog$object.set(G__45485,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__45524__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__45525__i < G__45525__a.length) {G__45525__a[G__45525__i] = arguments[G__45525__i + 0]; ++G__45525__i;}
  args = new cljs.core.IndexedSeq(G__45525__a,0,null);
} 
return G__45524__delegate.call(this,args);};
G__45524.cljs$lang$maxFixedArity = 0;
G__45524.cljs$lang$applyTo = (function (arglist__45526){
var args = cljs.core.seq(arglist__45526);
return G__45524__delegate(args);
});
...
var G__45486 = props;
var G__45486__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__45486,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__45486);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__45486__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5043__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__45487 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__45487,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__45487;
}
})(),id_class);
...
var G__45488 = (cljs.core.count(argv) - first_child);
switch (G__45488) {
case (0):
...
var vec__45491 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45491,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45491,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45491,(2),null);
...
var temp__5724__auto___45528 = reagent.impl.util.react_key_from_vec(v);
if((temp__5724__auto___45528 == null)){
} else {
var key_45529 = temp__5724__auto___45528;
(jsprops.key = key_45529);
}
...
var temp__5724__auto___45530 = reagent.impl.util.react_key_from_vec(v);
if((temp__5724__auto___45530 == null)){
} else {
var key_45531 = temp__5724__auto___45530;
(jsprops.key = key_45531);
}
...
var temp__5724__auto___45532 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5724__auto___45532 == null)){
} else {
var key_45533 = temp__5724__auto___45532;
(jsprops.key = key_45533);
}
...
var temp__5724__auto___45534 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5724__auto___45534 == null)){
} else {
var key_45535 = temp__5724__auto___45534;
(jsprops.key = key_45535);
}
...
var temp__5724__auto___45536 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5724__auto___45536 == null)){
} else {
var key_45537 = temp__5724__auto___45536;
(jsprops.key = key_45537);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__45501_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__45501_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__45502 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45502,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45502,(1),null);
...
break;
default:
var G__45539 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__45540 = compiler;
v = G__45539;
compiler = G__45540;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template45510 = (function (opts,id,fn_to_element,parse_fn,meta45511){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template45510.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_45512,meta45511__$1){
var self__ = this;
var _45512__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template45510(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta45511__$1));
}));

(reagent.impl.template.t_reagent$impl$template45510.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_45512){
var self__ = this;
var _45512__$1 = this;
return self__.meta45511;
}));

(reagent.impl.template.t_reagent$impl$template45510.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template45510.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template45510.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template45510.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template45510.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template45510.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta45511","meta45511",716287055,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template45510.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template45510.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template45510");

(reagent.impl.template.t_reagent$impl$template45510.cljs$lang$ctorPrWriter = (function (this__5327__auto__,writer__5328__auto__,opt__5329__auto__){
return cljs.core._write(writer__5328__auto__,"reagent.impl.template/t_reagent$impl$template45510");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template45510.
 */
reagent.impl.template.__GT_t_reagent$impl$template45510 = (function reagent$impl$template$__GT_t_reagent$impl$template45510(opts,id,fn_to_element,parse_fn,meta45511){
return (new reagent.impl.template.t_reagent$impl$template45510(opts,id,fn_to_element,parse_fn,meta45511));
});
...
return (new reagent.impl.template.t_reagent$impl$template45510(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
