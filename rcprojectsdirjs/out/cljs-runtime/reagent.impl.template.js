...
var G__38805 = o;
reagent.impl.template.goog$module$goog$object.set(G__38805,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
return (function() { 
var G__38823__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__38823 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__38824__i = 0, G__38824__a = new Array(arguments.length -  0);
while (G__38824__i < G__38824__a.length) {G__38824__a[G__38824__i] = arguments[G__38824__i + 0]; ++G__38824__i;}
  args = new cljs.core.IndexedSeq(G__38824__a,0,null);
} 
return G__38823__delegate.call(this,args);};
G__38823.cljs$lang$maxFixedArity = 0;
G__38823.cljs$lang$applyTo = (function (arglist__38825){
var args = cljs.core.seq(arglist__38825);
return G__38823__delegate(args);
});
...
var G__38806 = o;
reagent.impl.template.goog$module$goog$object.set(G__38806,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__38827__i < G__38827__a.length) {G__38827__a[G__38827__i] = arguments[G__38827__i + 0]; ++G__38827__i;}
  args = new cljs.core.IndexedSeq(G__38827__a,0,null);
} 
...
var G__38807 = props;
var G__38807__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38807,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__38807);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38807__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5043__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__38808 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__38808,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__38808;
}
})(),id_class);
...
var G__38809 = (cljs.core.count(argv) - first_child);
switch (G__38809) {
case (0):
...
var vec__38810 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38810,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38810,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38810,(2),null);
...
var temp__5724__auto___38830 = reagent.impl.util.react_key_from_vec(v);
if((temp__5724__auto___38830 == null)){
} else {
var key_38831 = temp__5724__auto___38830;
(jsprops.key = key_38831);
}
...
var temp__5724__auto___38832 = reagent.impl.util.react_key_from_vec(v);
if((temp__5724__auto___38832 == null)){
} else {
var key_38833 = temp__5724__auto___38832;
(jsprops.key = key_38833);
}
...
var temp__5724__auto___38838 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5724__auto___38838 == null)){
} else {
var key_38839 = temp__5724__auto___38838;
(jsprops.key = key_38839);
}
...
var temp__5724__auto___38840 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5724__auto___38840 == null)){
} else {
var key_38841 = temp__5724__auto___38840;
(jsprops.key = key_38841);
}
...
var temp__5724__auto___38843 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5724__auto___38843 == null)){
} else {
var key_38844 = temp__5724__auto___38843;
(jsprops.key = key_38844);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38813_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__38813_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__38814 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38814,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38814,(1),null);
...
break;
default:
var G__38847 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__38848 = compiler;
v = G__38847;
compiler = G__38848;
continue;
...
var G__38818 = tag;
var G__38818__$1 = (((G__38818 instanceof cljs.core.Keyword))?G__38818.fqn:null);
switch (G__38818__$1) {
case ">":
...
*/
reagent.impl.template.t_reagent$impl$template38820 = (function (opts,id,fn_to_element,parse_fn,meta38821){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template38820.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_38822,meta38821__$1){
var self__ = this;
var _38822__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template38820(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta38821__$1));
}));

(reagent.impl.template.t_reagent$impl$template38820.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_38822){
var self__ = this;
var _38822__$1 = this;
return self__.meta38821;
}));

(reagent.impl.template.t_reagent$impl$template38820.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template38820.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template38820.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template38820.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template38820.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template38820.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta38821","meta38821",-1412987939,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template38820.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template38820.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template38820");

(reagent.impl.template.t_reagent$impl$template38820.cljs$lang$ctorPrWriter = (function (this__5327__auto__,writer__5328__auto__,opt__5329__auto__){
return cljs.core._write(writer__5328__auto__,"reagent.impl.template/t_reagent$impl$template38820");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template38820.
 */
reagent.impl.template.__GT_t_reagent$impl$template38820 = (function reagent$impl$template$__GT_t_reagent$impl$template38820(opts,id,fn_to_element,parse_fn,meta38821){
return (new reagent.impl.template.t_reagent$impl$template38820(opts,id,fn_to_element,parse_fn,meta38821));
});
...
return (new reagent.impl.template.t_reagent$impl$template38820(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
